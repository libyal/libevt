...
#if !defined( _EVTTOOLS_WIDE_STRING_H )
#define _EVTTOOLS_WIDE_STRING_H
...
#define wide_string_compare_no_case( string1, string2, size ) \
	evttools_wide_string_compare_no_case( string1, string2, size )
...
#endif /* !defined( _EVTTOOLS_WIDE_STRING_H ) */
