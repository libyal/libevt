...
void (*evttools_signal_signal_handler)( evttools_signal_t ) = NULL;
             ...
             unsigned long signal )
{
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( evttools_signal_signal_handler != NULL )
			{
				evttools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
 ...
 */
void evttools_signal_initialize_memory_debug(
      void )
{
	int flag = 0;
 ...
 */
int evttools_signal_attach(
     void (*signal_handler)( evttools_signal_t ),
     libcerror_error_t **error )
{
	static char *function = "evttools_signal_attach";
...
#if defined( _MSC_VER )
	evttools_signal_initialize_memory_debug();
#endif
     ...
     libcerror_error_t **error )
{
	...
	evttools_signal_signal_handler = NULL;
