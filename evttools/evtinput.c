...
/* Determines the languague identifier from a string
 * Returns 1 if successful, 0 if unsupported value or -1 on error
 */
int evtinput_determine_language_identifier(
     const libcstring_system_character_t *string,
     int *language_identifier,
     liberror_error_t **error )
{
	static char *function = "evtinput_determine_language_identifier";
	size_t string_length  = 0;
	int result            = 0;
		...
		switch( string[ 0 ] )
		{
			...
			case (libcstring_system_character_t) 'a':
				switch( string[ 1 ] )
				{
					...
					case (libcstring_system_character_t) 'r':
						*language_identifier = EVTTOOLS_LANGUAGE_IDENTIFIER_AR;
						result               = 1;
						break;
			...
			case (libcstring_system_character_t) 'b':
				switch( string[ 1 ] )
				{
					...
					case (libcstring_system_character_t) 'g':
						*language_identifier = EVTTOOLS_LANGUAGE_IDENTIFIER_BG;
						result               = 1;
						break;
			...
			case (libcstring_system_character_t) 'c':
				switch( string[ 1 ] )
				{
					case (libcstring_system_character_t) 'A':
					case (libcstring_system_character_t) 'a':
						*language_identifier = EVTTOOLS_LANGUAGE_IDENTIFIER_CA;
						result               = 1;
						break;

					case (libcstring_system_character_t) 'S':
					case (libcstring_system_character_t) 's':
						*language_identifier = EVTTOOLS_LANGUAGE_IDENTIFIER_CS;
						result               = 1;
						break;
			...
			case (libcstring_system_character_t) 'd':
				switch( string[ 1 ] )
				{
					case (libcstring_system_character_t) 'A':
					case (libcstring_system_character_t) 'a':
						*language_identifier = EVTTOOLS_LANGUAGE_IDENTIFIER_DA;
						result               = 1;
						break;

					case (libcstring_system_character_t) 'E':
					case (libcstring_system_character_t) 'e':
						*language_identifier = EVTTOOLS_LANGUAGE_IDENTIFIER_DE;
						result               = 1;
						break;
			...
			case (libcstring_system_character_t) 'e':
				switch( string[ 1 ] )
				{
					...
					case (libcstring_system_character_t) 'l':
						*language_identifier = EVTTOOLS_LANGUAGE_IDENTIFIER_EL;
						result               = 1;
						break;

					case (libcstring_system_character_t) 'N':
					case (libcstring_system_character_t) 'n':
						*language_identifier = EVTTOOLS_LANGUAGE_IDENTIFIER_EN;
						result               = 1;
						break;

					case (libcstring_system_character_t) 'S':
					case (libcstring_system_character_t) 's':
						*language_identifier = EVTTOOLS_LANGUAGE_IDENTIFIER_ES;
						result               = 1;
						break;
			...
			case (libcstring_system_character_t) 'f':
				switch( string[ 1 ] )
				{
					...
					case (libcstring_system_character_t) 'i':
						*language_identifier = EVTTOOLS_LANGUAGE_IDENTIFIER_FI;
						result               = 1;
						break;

					case (libcstring_system_character_t) 'R':
					case (libcstring_system_character_t) 'r':
						*language_identifier = EVTTOOLS_LANGUAGE_IDENTIFIER_FR;
						result               = 1;
						break;
...
/* TODO remove if not used */
			...
			case (libcstring_system_character_t) 'h':
				switch( string[ 1 ] )
				{
					case (libcstring_system_character_t) 'E':
					case (libcstring_system_character_t) 'e':
						*language_identifier = EVTTOOLS_LANGUAGE_IDENTIFIER_HE;
						result               = 1;
						break;

					case (libcstring_system_character_t) 'U':
					case (libcstring_system_character_t) 'u':
						*language_identifier = EVTTOOLS_LANGUAGE_IDENTIFIER_HU;
						result               = 1;
						break;
			...
			case (libcstring_system_character_t) 'i':
				switch( string[ 1 ] )
				{
					case (libcstring_system_character_t) 'S':
					case (libcstring_system_character_t) 's':
						*language_identifier = EVTTOOLS_LANGUAGE_IDENTIFIER_IS;
						result               = 1;
						break;

					case (libcstring_system_character_t) 'T':
					case (libcstring_system_character_t) 't':
						*language_identifier = EVTTOOLS_LANGUAGE_IDENTIFIER_IT;
						result               = 1;
						break;
			...
			case (libcstring_system_character_t) 'j':
				switch( string[ 1 ] )
				{
					case (libcstring_system_character_t) 'A':
					case (libcstring_system_character_t) 'a':
						*language_identifier = EVTTOOLS_LANGUAGE_IDENTIFIER_JA;
						result               = 1;
						break;
			...
			case (libcstring_system_character_t) 'k':
				switch( string[ 1 ] )
				{
					...
					case (libcstring_system_character_t) 'o':
						*language_identifier = EVTTOOLS_LANGUAGE_IDENTIFIER_KO;
						result               = 1;
						break;
...
/* TODO remove if not used */
			...
			case (libcstring_system_character_t) 'n':
				switch( string[ 1 ] )
				{
					case (libcstring_system_character_t) 'L':
					case (libcstring_system_character_t) 'l':
						*language_identifier = EVTTOOLS_LANGUAGE_IDENTIFIER_NL;
						result               = 1;
						break;

					case (libcstring_system_character_t) 'O':
					case (libcstring_system_character_t) 'o':
						*language_identifier = EVTTOOLS_LANGUAGE_IDENTIFIER_NO;
						result               = 1;
						break;
