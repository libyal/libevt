...
#if !defined( _EVTTOOLS_GETOPT_H )
#define _EVTTOOLS_GETOPT_H
...
typedef struct evttools_option evttools_option_t;

struct evttools_option
{
...
#define evttools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t evttools_getopt(
                  int argument_count,
...
void evttools_getopt_wrapped_fprint(
      FILE *stream,
...
void evttools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const evttools_option_t *options,
      int number_of_options );

int evttools_getopt_get_options_string(
     const evttools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _EVTTOOLS_GETOPT_H ) */
