...
{
	static char *function = "libevt_notify_set_stream";
...
int libevt_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libevt_notify_stream_open";
...
int libevt_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libevt_notify_stream_close";
