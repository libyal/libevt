...
#if !defined( _LIBEVT_LIBCTHREADS_H )
#define _LIBEVT_LIBCTHREADS_H

#include <common.h>

#if defined( HAVE_MULTI_THREAD_SUPPORT ) && !defined( HAVE_LOCAL_LIBEVT )
#define HAVE_LIBEVT_MULTI_THREAD_SUPPORT
#endif
...
#endif /* defined( HAVE_LIBEVT_MULTI_THREAD_SUPPORT ) */

#endif /* !defined( _LIBEVT_LIBCTHREADS_H ) */
