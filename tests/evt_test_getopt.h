...
#if !defined( _EVT_TEST_GETOPT_H )
#define _EVT_TEST_GETOPT_H
...
#define evt_test_getopt( argument_count, argument_values, options_string ) \
...
#endif /* !defined( _EVT_TEST_GETOPT_H ) */
