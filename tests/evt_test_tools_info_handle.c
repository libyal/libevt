...
#include "../evttools/info_handle.h"

/* Tests the info_handle_initialize function
 * Returns 1 if successful or 0 if not
 */
int evt_test_tools_info_handle_initialize(
     void )
{
 ...
 * Returns 1 if successful or 0 if not
 */
int evt_test_tools_info_handle_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
#endif
{
	...
	EVT_TEST_RUN(
	 ...
	 evt_test_tools_info_handle_initialize );

	EVT_TEST_RUN(
	 "info_handle_free",
	 evt_test_tools_info_handle_free );
