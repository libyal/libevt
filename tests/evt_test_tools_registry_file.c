...
#include "../evttools/registry_file.h"

/* Tests the registry_file_initialize function
 * Returns 1 if successful or 0 if not
 */
int evt_test_tools_registry_file_initialize(
     void )
{
 ...
 * Returns 1 if successful or 0 if not
 */
int evt_test_tools_registry_file_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
#endif
{
	...
	EVT_TEST_RUN(
	 ...
	 evt_test_tools_registry_file_initialize );

	EVT_TEST_RUN(
	 "registry_file_free",
	 evt_test_tools_registry_file_free );
