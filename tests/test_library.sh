...
LIBRARY_TESTS="end_of_file_record error file_header io_handle notify record record_values";
...
run_test_with_input()
{
	...
	local TEST_PROFILE_DIRECTORY=$(get_test_profile_directory "input" "libevt");
