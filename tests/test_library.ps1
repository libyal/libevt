...
Foreach (${TestName} in ${LibraryTests} -split " ")
{
	...
	$ResultRun = RunTestBinary ${TestExecutablesDirectory} "evt_test_${TestName}"
...
$TestInputs = GenerateTestInputs "libevt" ${OptionSets}
...
Foreach (${TestName} in ${LibraryTestsWithInput} -split " ")
{
	...
	{
		$ResultRun = RunTestBinaryWithInput ${TestExecutablesDirectory} "evt_test_${TestName}" ${TestInput}
